...
system_name = 'trader2' # system's name, used for logging system
database = 'market2.db' # database to store market data and order submitted
exchange_name = socket.gethostname() # host name of the machine that exchange runs on
book_port = 6325        # internal socket between bookbuilder and getawayIN
order_port = 6326       # internal socket between trader and getawayOUT
exchange_data_port = 5552 # exchange port to broadcast market data
exchange_order_port = 5562 # exchange port to receive order
robot_trader_style = 'riskseeker' # robot trader's style
robot_trader_strategy = 'volatility'  # robot trader's strategy
is_robot_trader = True   # this is a robot trader, who submit random orders according to style and strategy
trade_interval = 6   # sleep time between each trade
