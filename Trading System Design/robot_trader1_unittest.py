...
system_name = 'trader1' # system's name, used for logging system
database = 'market1.db' # database to store market data and order submitted
exchange_name = socket.gethostname() # host name of the machine that exchange runs on
book_port = 6315        # internal socket between bookbuilder and getawayIN
order_port = 6316       # internal socket between trader and getawayOUT
exchange_data_port = 5551 # exchange port to broadcast market data
exchange_order_port = 5561 # exchange port to receive order
robot_trader_style = 'neutral' # robot trader's style
...
trade_interval = 3   # sleep time between each trade
