%macro lifesaver(client_dir=, client_data=, client_id=, state_var=, zip5=, zip4=, state_list=, ethnic=1, geo_interest=1, census=1, census_keep=,  email=jschiltz@cac-group.com);
*==============================================================================================*;
*  Macro:  	lifesaver 
...
data oops;
   set &clib..&client_data (keep=&client_id cacdirect_hh_match cac_hh_pid &zip5 &zip4 cac_addr_zip cac_addr_zip4 cac_addr_state &state_var) end=eof;
...
*-----------------------------------------*;
      ...
      %let light= geo_cac_int_10  geo_cac_int_100 geo_cac_int_102 geo_cac_int_103  geo_cac_int_105 geo_cac_int_106  geo_cac_int_107 geo_cac_int_108 geo_cac_int_11 geo_cac_int_110  geo_cac_int_111
                  geo_cac_int_113  geo_cac_int_114  geo_cac_int_115 geo_cac_int_116 geo_cac_int_118  geo_cac_int_121 geo_cac_int_14 geo_cac_int_15  geo_cac_int_17 geo_cac_int_19  geo_cac_int_2
                  geo_cac_int_20  geo_cac_int_22  geo_cac_int_23  geo_cac_int_24  geo_cac_int_25 geo_cac_int_26 geo_cac_int_27  geo_cac_int_28  geo_cac_int_3  geo_cac_int_30  geo_cac_int_31
                  geo_cac_int_32 geo_cac_int_34 geo_cac_int_35  geo_cac_int_36 geo_cac_int_37 geo_cac_int_39  geo_cac_int_4 geo_cac_int_47 geo_cac_int_49  geo_cac_int_50  geo_cac_int_51
                  geo_cac_int_52  geo_cac_int_55  geo_cac_int_57  geo_cac_int_58  geo_cac_int_59 geo_cac_int_6  geo_cac_int_60  geo_cac_int_61 geo_cac_int_64  geo_cac_int_65  geo_cac_int_67  
                  geo_cac_int_68  geo_cac_int_69 geo_cac_int_7 geo_cac_int_72 geo_cac_int_73  geo_cac_int_74  geo_cac_int_76  geo_cac_int_77  geo_cac_int_78  geo_cac_int_79  geo_cac_int_82  
                  geo_cac_int_84 geo_cac_int_87  geo_cac_int_88  geo_cac_int_9 geo_cac_int_90 geo_cac_int_91 geo_cac_int_92 geo_cac_int_94  geo_cac_int_95  geo_cac_int_96  geo_cac_int_97 geo_cac_int_98  ;
         ...
         data client_z2_found_&curstate (drop=newzip) zip_&curstate (rename=(cac_addr_zip2=hold));
            ...
            merge client_z2_&curstate (in=a)
                  geo.geo_interest_&curstate (in=b keep=cac_addr_zip2 &light drop=cac_addr_state cac_addr_zip);
            by cac_addr_zip2;
            cac_geo_match=1;
...
*-----------------------------------------*;
      %if &census=1 %then %do ;
         ...
         data oops_&curstate ;
            merge oops_&curstate(in=a)
                  cen2010.cac_census_final_&curstate (in=b keep=match_zip5 match_zip4 cen_count_pop cen_factor11 cen_factor14 cen_faminc_5 cen_hhage_5
                                                                cen_hserace_1 cen_hserent_5 cen_hseval_8 cen_hseveh_2 rename=(cac_addr_zip=match_zip5 cac_addr_zip4=match_zip4));
            by match_zip5 match_zip4;
            if a;
            cac_census_match=b;
         run;
...
data &clib..&client_data._saved;
  merge client_in (in=a)
        oops_matched (in=b drop=match_zip5 match_zip4 match_zip2 &zip5 &zip4 &state_var match_state cac_hh_pid cac_addr_zip cac_addr_zip4 cac_addr_state);
   by &client_id;
   if a AND b;
   %if &geo_interest=1 %then %do; 
