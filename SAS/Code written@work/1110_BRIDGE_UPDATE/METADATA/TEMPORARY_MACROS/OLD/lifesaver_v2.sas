%macro lifesaver(client_dir=, client_data=, client_id=, state_var=, zip5=, zip4=, state_list=, base=1, ethnic=1, geo_interest=1, census=1, census_keep=,  email=kdietz@cac-group.com);
*==============================================================================================*;
*  Macro:  	lifesaver 
      ...
      %if &census=1 %then %do ;
         ...
         data oops_&curstate;
            merge client_with_cen_id_&curstate (in=a)
                  cen2010.cac_census_final_&curstate (in=b keep=cac_census_id CEN_HHAGE_3 CEN_POPAGE_31 CEN_HHSIZE_7 CEN_HSECOST_3 CEN_HHINC_25 CEN_HSEVAL_8);
            by cac_census_id;
            if a and b;
         run;
