...
*** MOVE UPDATE RAW FILE ***;

   filename nmlst_1 temp;
   data nmlsttemp_1;
   ...
   %nobs(data=nmlsttemp_1);
   %let pknobs_1=&nobs;

   data _null_;
      file nmlst_1;
      set nmlsttemp_1 end=eof;
      if _n_=1 then put '%let nmlst_1=';
      put filename;
      if eof then put ';';
   run;
...
%put LIST OF UPDATE IMPORTED: &nmlst_1;

%do pk=1 %to &pknobs_1;
   x "mv /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/VALUESCORE_UPDATE/%scan(&nmlst_1,&pk,' ') /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/IMPORTED";
%end;
...
x "mv ./020_update_import.log ./LOGS/020_update_import_&tdate..log";
x "mv ./020_update_import.lst ./LOGS/020_update_import_&tdate..lst";
x "mv ./030_mover_processing.log ./LOGS/030_mover_processing_&tdate..log";
x "mv ./030_mover_processing.lst ./LOGS/030_mover_processing_&tdate..lst";

x "mv ./qc_report*htm ./LOGS"; 
x "mv ./file_listing.txt ./LOGS/file_listing_&tdate..txt";
x "mv ./file_listing_update.txt ./LOGS/file_listing_update_&tdate..txt";
...
*** FOR UPDATE FILE ***;
x "mv /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/VALUESCORE_UPDATE/*.html /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/DOCUMENTATION";
x "mv /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/VALUESCORE_UPDATE/*xml /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/DOCUMENTATION";
x "mv /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/VALUESCORE_UPDATE/*rtf /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/DOCUMENTATION";
x "mv /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/VALUESCORE_UPDATE/*PDF /project/CACDIRECT/DATA/NEW_MOVER/EPSILON/RAW/DOCUMENTATION";
