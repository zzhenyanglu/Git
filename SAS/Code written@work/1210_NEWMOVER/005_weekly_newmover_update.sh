...
psql -h ail-postgres.cxj89kwq46vz.us-west-2.rds.amazonaws.com -U ais --port=5432 dbname=cac_prod -f ${code_path}001_load_raw_file.sql 
psql -h ail-postgres.cxj89kwq46vz.us-west-2.rds.amazonaws.com -U ais --port=5432 dbname=cac_prod -f ${code_path}002_update_value_score.sql 
psql -h ail-postgres.cxj89kwq46vz.us-west-2.rds.amazonaws.com -U ais --port=5432 dbname=cac_prod -f ${code_path}003_cleanup.sql
