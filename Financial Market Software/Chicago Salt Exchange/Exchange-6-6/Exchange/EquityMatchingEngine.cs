...
namespace EquityMatchingEngine
{
    public class OMEHost
    {
        ...
        public static bool open = false; // 0 means closed, 1 means just starting, 2 means exchange is fully started
        public static DateTime startTime;
        public static TimeSpan stagingTime = TimeSpan.FromMinutes(1);//after exchaange is started the exchange takse orders and finds opening price for one minute
        [STAThread]
