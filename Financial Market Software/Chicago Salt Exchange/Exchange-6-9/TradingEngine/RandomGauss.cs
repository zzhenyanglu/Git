...
namespace TradingEngine
{
    ...
    public class RandomGauss
    {
        ...
        public static void OrderExecuted(FuturesOrder ExOrder)
        {
        ...
        private void csvWriter(FuturesOrder newOrder)
        {
        System.Text.StringBuilder theBuilder = new System.Text.StringBuilder();

                theBuilder.Append(newOrder.Active);
                theBuilder.Append(",");
                theBuilder.Append(newOrder.BuySell);
                theBuilder.Append(",");
                theBuilder.Append(newOrder.CustomerID);
                theBuilder.Append(",");
                theBuilder.Append(newOrder.Instrument);
                theBuilder.Append(",");
                    theBuilder.Append( newOrder.LimitPrice);
                    theBuilder.Append(",");
            theBuilder.Append(newOrder.Message);
            theBuilder.Append(",");
            theBuilder.Append(newOrder.OrderAction);
            theBuilder.Append(",");
            theBuilder.Append(newOrder.OrderID);
            theBuilder.Append(",");
            theBuilder.Append(newOrder.OrderType);
            theBuilder.Append(",");
            theBuilder.Append(newOrder.OrigQuantity);
            theBuilder.Append(",");
            theBuilder.Append(newOrder.Quantity);
            theBuilder.Append(",");
            theBuilder.Append(newOrder.Status);
            theBuilder.Append(",");
            theBuilder.Append(newOrder.StopPrice);
            theBuilder.Append(",");
            theBuilder.Append(newOrder.TimeStamp);
            string order = theBuilder.ToString() + Environment.NewLine;
            //using (StreamWriter theWriter = new StreamWriter(@"C:\Users\Mike\Documents\Visual Studio 2012\Projects\Exchange\log.csv"))
            string fileName = @"C:\log.csv";
            File.AppendAllText(fileName, order.ToString());
